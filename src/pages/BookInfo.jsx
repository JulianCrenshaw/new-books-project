          ...
          <div className="row">
            ...
            <div className="book__selected">
                ...
                <div className="book__selected--description">
                    ...
                    <div className="book__summary">An amazing book about a great deal of practice in how to achieve success in a interview for a coding job near you location</div>
                </div>
            </div>
          </div>
        </div>
